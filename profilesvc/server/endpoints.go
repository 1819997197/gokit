...
func MakeServerEndpoints(s Service) Endpoints {
	...
	return Endpoints{
		PostProfileEndpoint:   NewTokenBucketLimitterWithBuildIn(ratebucket)(MakePostProfileEndpoint(s)),
		GetProfileEndpoint:    NewTokenBucketLimitterWithBuildIn(ratebucket)(MakeGetProfileEndpoint(s)),
		PutProfileEndpoint:    NewTokenBucketLimitterWithBuildIn(ratebucket)(MakePutProfileEndpoint(s)),
		PatchProfileEndpoint:  NewTokenBucketLimitterWithBuildIn(ratebucket)(MakePatchProfileEndpoint(s)),
		DeleteProfileEndpoint: NewTokenBucketLimitterWithBuildIn(ratebucket)(MakeDeleteProfileEndpoint(s)),
		GetAddressesEndpoint:  NewTokenBucketLimitterWithBuildIn(ratebucket)(MakeGetAddressesEndpoint(s)),
		GetAddressEndpoint:    NewTokenBucketLimitterWithBuildIn(ratebucket)(MakeGetAddressEndpoint(s)),
		PostAddressEndpoint:   NewTokenBucketLimitterWithBuildIn(ratebucket)(MakePostAddressEndpoint(s)),
		DeleteAddressEndpoint: NewTokenBucketLimitterWithBuildIn(ratebucket)(MakeDeleteAddressEndpoint(s)),
	}
}
